$(document).ready( function() {
    ...
    $(document).on('click', '.create-product-button', function(){
    	...
    	$.getJSON("http://jsonplaceholder.typicode.com/users", function(data){
			...
			categories_options_html += "<select name='userId' class='form-control'>";

			$.each(data, function(key, val){
			    categories_options_html += "<option value='" + val.id + "'>" + val.id + "</option>";
			});
			...
			create_product_html+="<table class='table table-hover table-responsive table-bordered'>";
		        ...
		        create_product_html+="<td><input type='number' min='1' name='id' class='form-control' required /></td>";
		        create_product_html+="</tr>";
		        
		        // name field
		        create_product_html+="<tr>";
		        create_product_html+="<td>Name</td>";
		        create_product_html+="<td><input type='text' name='title' class='form-control' required /></td>";
		        create_product_html+="</tr>";
